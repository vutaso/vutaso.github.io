window.I18n = (() => {
  ...
  const STRINGS = {
    en: {
      ...
      apiKeyOpencodeGo: 'OpenCode Go API key...',
      apiKeyPerplexity: 'pplx-...',
      ...
      apiKeyLabelOpencodeGo: 'OpenCode Go',
      apiKeyLabelPerplexity: 'Perplexity',
      ...
      missingApiKeyOpencodeGo: 'Enter your OpenCode Go API key in Settings first',
      missingApiKeyPerplexity: 'Enter your Perplexity API key in Settings first',
      ...
      missingApiKeyErrorOpencodeGo: 'No OpenCode Go API key. Open Settings to enter one.',
      missingApiKeyErrorPerplexity: 'No Perplexity API key. Open Settings to enter one.',
      ...
      opencodeGoProxyRequired: 'OpenCode Go API cannot be called directly from the browser (CORS). Deploy worker/ and set OPENCODE_GO proxy endpoints in config.js.',
      opencodeGoProxyNetworkError: 'Could not reach OpenCode Go proxy. Check API key in Settings, open the app via http://localhost:5500 or https://vutaso.github.io (not file://), then redeploy worker/.',
      perplexityProxyRequired: 'Perplexity API cannot be called directly from the browser (CORS). Deploy worker/ and set PERPLEXITY_PROXY_ENDPOINT in config.js.',
      perplexityProxyNetworkError: 'Could not reach Perplexity proxy. Check API key in Settings, open the app via http://localhost:5500 or https://vutaso.github.io (not file://), then redeploy worker/.',
    ...
    vi: {
      ...
      missingApiKeyOpencodeGo: 'Nhập OpenCode Go API key trong Cài đặt trước',
      missingApiKeyPerplexity: 'Nhập Perplexity API key trong Cài đặt trước',
      ...
      missingApiKeyErrorOpencodeGo: 'Chưa có OpenCode Go API key. Mở Cài đặt để nhập.',
      missingApiKeyErrorPerplexity: 'Chưa có Perplexity API key. Mở Cài đặt để nhập.',
      ...
      opencodeGoProxyRequired: 'OpenCode Go API không gọi trực tiếp được từ trình duyệt (CORS). Cần deploy Cloudflare Worker trong thư mục worker/ và cấu hình OPENCODE_GO proxy endpoints trong config.js.',
      opencodeGoProxyNetworkError: 'Không kết nối được proxy OpenCode Go. Kiểm tra API key trong Cài đặt, mở app qua http://localhost:5500 hoặc https://vutaso.github.io (không mở file:// trực tiếp), rồi chạy lại npx wrangler deploy trong worker/.',
      perplexityProxyRequired: 'Perplexity API không gọi trực tiếp được từ trình duyệt (CORS). Cần deploy Cloudflare Worker trong thư mục worker/ và cấu hình PERPLEXITY_PROXY_ENDPOINT trong config.js.',
      perplexityProxyNetworkError: 'Không kết nối được proxy Perplexity. Kiểm tra API key trong Cài đặt, mở app qua http://localhost:5500 hoặc https://vutaso.github.io (không mở file:// trực tiếp), rồi chạy lại npx wrangler deploy trong worker/.',
    ...
    jp: {
      ...
      missingApiKeyOpencodeGo: '先に設定でOpenCode Go APIキーを入力してください',
      missingApiKeyPerplexity: '先に設定でPerplexity APIキーを入力してください',
      ...
      missingApiKeyErrorOpencodeGo: 'OpenCode Go APIキーがありません。設定を開いて入力してください。',
      missingApiKeyErrorPerplexity: 'Perplexity APIキーがありません。設定を開いて入力してください。',
      ...
      opencodeGoProxyRequired: 'OpenCode Go APIはブラウザから直接呼び出せません（CORS）。worker/をデプロイし、OPENCODE_GO proxy endpointsを設定してください。',
      opencodeGoProxyNetworkError: 'OpenCode Goプロキシに接続できません。設定のAPIキー、http://localhost:5500 または https://vutaso.github.io で開くこと（file://不可）、worker/ の再デプロイを確認してください。',
      perplexityProxyRequired: 'Perplexity APIはブラウザから直接呼び出せません（CORS）。worker/をデプロイし、PERPLEXITY_PROXY_ENDPOINTを設定してください。',
      perplexityProxyNetworkError: 'Perplexityプロキシに接続できません。設定のAPIキー、http://localhost:5500 または https://vutaso.github.io で開くこと（file://不可）、worker/ の再デプロイを確認してください。',
    ...
    zh: {
      ...
      missingApiKeyOpencodeGo: '请先在设置中输入 OpenCode Go API Key',
      missingApiKeyPerplexity: '请先在设置中输入 Perplexity API Key',
      ...
      missingApiKeyErrorOpencodeGo: '未设置 OpenCode Go API Key。请打开设置输入。',
      missingApiKeyErrorPerplexity: '未设置 Perplexity API Key。请打开设置输入。',
      ...
      opencodeGoProxyRequired: 'OpenCode Go API 无法从浏览器直接调用（CORS）。请部署 worker/ 并配置 OPENCODE_GO proxy endpoints。',
      opencodeGoProxyNetworkError: '无法连接 OpenCode Go 代理。请检查设置中的 API Key，通过 http://localhost:5500 或 https://vutaso.github.io 打开（不要用 file://），并重新部署 worker/。',
      perplexityProxyRequired: 'Perplexity API 无法从浏览器直接调用（CORS）。请部署 worker/ 并配置 PERPLEXITY_PROXY_ENDPOINT。',
      perplexityProxyNetworkError: '无法连接 Perplexity 代理。请检查设置中的 API Key，通过 http://localhost:5500 或 https://vutaso.github.io 打开（不要用 file://），并重新部署 worker/。',
  ...
  const DOM_BINDINGS = [
    ...
    { sel: 'label[for="opencodeGoApiKeyInput"]', key: 'apiKeyLabelOpencodeGo' },
    { sel: 'label[for="perplexityApiKeyInput"]', key: 'apiKeyLabelPerplexity' },
    ...
    { sel: '#opencodeGoApiKeyInput', attr: 'placeholder', key: 'apiKeyOpencodeGo', raw: 'OpenCode Go API key...' },
    { sel: '#perplexityApiKeyInput', attr: 'placeholder', key: 'apiKeyPerplexity', raw: 'pplx-...' },
  ...
  const getMissingApiKeyMessage = (modelId) => {
    ...
    if (provider === 'opencode-go') return t('missingApiKeyOpencodeGo');
    if (provider === 'perplexity') return t('missingApiKeyPerplexity');
  ...
  const getMissingApiKeyError = (modelId) => {
    ...
    if (provider === 'opencode-go') return t('missingApiKeyErrorOpencodeGo');
    if (provider === 'perplexity') return t('missingApiKeyErrorPerplexity');
