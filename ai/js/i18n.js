window.I18n = (() => {
  ...
  const STRINGS = {
    en: {
      ...
      webSearchTitle: 'Search the web and fetch page content',
      shell: 'Shell',
      ...
      settingsUsageDash: 'Cost dashboard',
      settingsUsageDashHint: 'Estimated spend across all chats. Reset starts a new period; per-chat token totals stay.',
      settingsUsageDash7d: '7d',
      settingsUsageDash30d: '30d',
      settingsUsageDashPeriod: 'Period',
      settingsUsageDashReset: 'Reset period',
      settingsUsageDashResetConfirm: 'Clear the cost dashboard and start a new period? Per-chat token totals are kept.',
      settingsUsageDashResetDone: 'New cost period started',
      settingsUsageDashEmpty: 'No usage in this range yet.',
      settingsUsageDashModels: 'By model',
      settingsUsageDashMore: '+{n} more',
      settingsUsageDashResetAt: 'Period started {date}',
      settingsUsageDashInOut: 'In {input} · Out {output}',
      ...
      settingsBackupHint: 'Export conversations, prompts, and preferences to a JSON file. Restore after switching browsers or clearing storage.',
      backupIncludeKeys: 'Include API keys (keep this file private)',
      backupExportBtn: 'Export JSON',
      backupRestoreBtn: 'Restore…',
      backupRestoreTitle: 'Restore backup',
      backupRestoreSubtitle: 'Choose how to apply this file',
      backupRestoreSummary: '{conversations} conversations · {messages} messages · {snippets} prompts',
      backupRestoreDate: 'Exported {date}',
      backupRestoreDateUnknown: 'Export date unknown',
      backupRestoreHelp: 'Replace overwrites chats and prompts on this device. Merge keeps yours and adds from the file. API keys stay on this device unless you opt in.',
      backupRestoreKeys: 'Also restore API keys from this file',
      backupRestoreMerge: 'Merge',
      backupRestoreReplace: 'Replace',
      backupConfirmReplace: 'Replace all conversations and prompts on this device with this backup? This cannot be undone.',
      ...
      guideGotIt: 'Got it',
      reply: 'Reply',
      exportPdfTitle: 'Opening print dialog...',
      exportHtmlTitle: 'Exporting HTML...',
      exportPdfHint: 'Turn off Headers and footers, then Save as PDF',
      ...
      chatFind: 'Find in chat',
      chatFindPlaceholder: 'Find in this conversation',
      chatFindPrev: 'Previous match',
      chatFindNext: 'Next match',
      chatFindClose: 'Close find',
      chatFindCount: '{current}/{total}',
      chatFindCountCapped: '{current}/{total}+',
      chatFindNone: 'No matches',
      ...
      downloadTableCsv: 'Download CSV',
      scrollMsgTop: 'Scroll to top',
      scrollMsgBottom: 'Scroll to bottom',
      retry: 'Regenerate',
      continueGeneration: 'Continue',
      continueGenerationTitle: 'Continue from where the answer was cut',
      branch: 'New branch',
      ...
      snippetsSubtitle: 'Save and reuse prompts. Type /review or /summary in the input to insert quickly.',
      ...
      slashCommandEmpty: 'No matching prompts',
      slashCommandHint: '↑↓ to choose · Enter to insert · Esc to close',
      ...
      compressAborted: 'Compression cancelled. Original messages were kept.',
      compressApplyFailed: 'Could not apply the summary because the chat changed',
      ...
      compareStatusTruncated: 'Cut off — pick then Continue',
      ...
      responseModelLabel: '{model}',
      sources: 'Sources',
      sourcesQuery: 'Searched: {q}',
      ...
      fetchingWeb: 'Fetching page content...',
      runningShell: 'Running commands in sandbox...',
      shellPending: 'Shell sandbox active…',
      ...
      toastExportPdfOk: 'Print dialog opened — save as PDF if needed',
      toastExportPdfFail: 'Could not open print dialog: {err}',
      ...
      toastShellOn: 'Shell sandbox enabled',
      toastShellOff: 'Shell sandbox disabled',
      ...
      toastDownloadCsv: 'CSV file downloaded',
      ...
      toastBackupExportOk: 'Backup downloaded',
      toastBackupExportFail: 'Could not export backup: {err}',
      toastBackupRestoreReplace: 'Restored {conversations} conversations and {snippets} prompts',
      toastBackupRestoreMerge: 'Added {conversations} conversations and {snippets} prompts',
      toastBackupRestoreNothing: 'Nothing new to add from this backup',
      toastBackupRestoreUsage: 'Updated cost dashboard from backup',
      toastBackupRestoreFail: 'Could not restore backup: {err}',
      backupInvalidJson: 'This file is not valid JSON',
      backupInvalidFormat: 'This is not a Vutaso AI backup file',
      backupFileTooLarge: 'This backup is too large to restore in the browser ({size}).',
      backupConfirmExportLarge: 'This backup is {size}. Downloading or restoring a file this large may freeze the tab. Continue?',
      ...
      guideStep3Li4: '<kbd>Ctrl</kbd>/<kbd>Cmd</kbd> + <kbd>F</kbd> — find in this conversation',
      guideStep3Li5: '<kbd>/</kbd> — slash commands from the prompt library (<kbd>/review</kbd>, <kbd>/summary</kbd>)',
      ...
      guideStep8Body: 'Header: download Markdown, copy Markdown, export Word (.docx), print / save PDF. AI responses support Markdown, code highlight, math, Mermaid diagrams.',
      guideStep8Li1: '<kbd>Escape</kbd> — close find, modal, menu, preview; exit edit mode'
    },
    vi: {
      ...
      webSearchTitle: 'Tìm kiếm web và đọc nội dung trang',
      shell: 'Shell',
      ...
      settingsUsageDash: 'Chi phí theo ngày',
      settingsUsageDashHint: 'Ước tính trên mọi cuộc chat. Reset bắt đầu kỳ mới; tổng token từng chat vẫn giữ.',
      settingsUsageDash7d: '7 ngày',
      settingsUsageDash30d: '30 ngày',
      settingsUsageDashPeriod: 'Kỳ này',
      settingsUsageDashReset: 'Reset kỳ',
      settingsUsageDashResetConfirm: 'Xóa dashboard chi phí và bắt đầu kỳ mới? Tổng token từng cuộc chat được giữ lại.',
      settingsUsageDashResetDone: 'Đã bắt đầu kỳ chi phí mới',
      settingsUsageDashEmpty: 'Chưa có dữ liệu trong khoảng này.',
      settingsUsageDashModels: 'Theo model',
      settingsUsageDashMore: '+{n} model',
      settingsUsageDashResetAt: 'Kỳ bắt đầu {date}',
      settingsUsageDashInOut: 'In {input} · Out {output}',
      ...
      settingsBackupHint: 'Xuất hội thoại, thư viện prompt và cài đặt ra file JSON. Khôi phục khi đổi trình duyệt hoặc xóa dữ liệu máy.',
      backupIncludeKeys: 'Bao gồm API key (giữ file này ở nơi riêng tư)',
      backupExportBtn: 'Xuất JSON',
      backupRestoreBtn: 'Khôi phục…',
      backupRestoreTitle: 'Khôi phục bản sao lưu',
      backupRestoreSubtitle: 'Chọn cách áp dụng file này',
      backupRestoreSummary: '{conversations} hội thoại · {messages} tin nhắn · {snippets} prompt',
      backupRestoreDate: 'Xuất lúc {date}',
      backupRestoreDateUnknown: 'Không rõ thời điểm xuất',
      backupRestoreHelp: 'Thay thế sẽ ghi đè hội thoại và prompt trên máy này. Gộp sẽ giữ dữ liệu hiện có và thêm từ file. API key trên máy được giữ lại trừ khi bạn chọn khôi phục key.',
      backupRestoreKeys: 'Khôi phục cả API key từ file này',
      backupRestoreMerge: 'Gộp',
      backupRestoreReplace: 'Thay thế',
      backupConfirmReplace: 'Thay thế toàn bộ hội thoại và prompt trên máy này bằng bản sao lưu? Hành động này không thể hoàn tác.',
      ...
      guideGotIt: 'Đã hiểu',
      reply: 'Reply',
      exportPdfTitle: 'Đang mở hộp thoại in...',
      exportHtmlTitle: 'Đang xuất HTML...',
      exportPdfHint: 'Tắt Headers and footers (Đầu/chân trang), rồi chọn Lưu PDF',
      ...
      chatFind: 'Tìm trong cuộc chat',
      chatFindPlaceholder: 'Tìm trong cuộc chat này',
      chatFindPrev: 'Kết quả trước',
      chatFindNext: 'Kết quả sau',
      chatFindClose: 'Đóng tìm',
      chatFindCount: '{current}/{total}',
      chatFindCountCapped: '{current}/{total}+',
      chatFindNone: 'Không có',
      noConversations: 'Chưa có cuộc trò chuyện nào',
      conversationGenerating: 'Đang tạo nội dung…',
      ...
      downloadTableCsv: 'Tải file CSV',
      scrollMsgTop: 'Cuộn lên đầu',
      scrollMsgBottom: 'Cuộn xuống cuối',
      retry: 'Tạo lại',
      continueGeneration: 'Tiếp tục',
      continueGenerationTitle: 'Tiếp tục sinh từ đoạn đang bị cắt',
      ...
      snippetsSubtitle: 'Lưu và tái sử dụng các câu lệnh hay dùng. Gõ /review, /summary trong ô nhập để chèn nhanh.',
      ...
      slashCommandEmpty: 'Không có prompt khớp',
      slashCommandHint: '↑↓ chọn · Enter chèn · Esc đóng',
      ...
      compressAborted: 'Đã huỷ nén. Các tin gốc được giữ nguyên.',
      compressApplyFailed: 'Không áp dụng được tóm tắt vì hội thoại đã thay đổi',
      ...
      compareStatusTruncated: 'Bị cắt — chọn rồi bấm Tiếp tục',
      ...
      fetchingWeb: 'Đang tải nội dung trang...',
      runningShell: 'Đang chạy lệnh trong sandbox...',
      shellPending: 'Đang dùng Shell sandbox…',
      ...
      toastExportPdfOk: 'Đã mở hộp thoại in — chọn Lưu PDF nếu cần',
      toastExportPdfFail: 'Không mở được hộp thoại in: {err}',
      toastModel: 'Model: {label}',
      toastProvider: 'Nhà cung cấp: {label}',
      toastWebSearchOn: 'Đã bật tìm kiếm web',
      toastWebSearchOff: 'Đã tắt tìm kiếm web',
      toastShellOn: 'Đã bật Shell sandbox',
      toastShellOff: 'Đã tắt Shell sandbox',
      ...
      toastDownloadCsv: 'Đã tải file CSV',
      ...
      toastBackupExportOk: 'Đã tải file sao lưu',
      toastBackupExportFail: 'Không xuất được bản sao lưu: {err}',
      toastBackupRestoreReplace: 'Đã khôi phục {conversations} hội thoại và {snippets} prompt',
      toastBackupRestoreMerge: 'Đã thêm {conversations} hội thoại và {snippets} prompt',
      toastBackupRestoreNothing: 'File này không có dữ liệu mới để thêm',
      toastBackupRestoreUsage: 'Đã cập nhật dashboard chi phí từ bản sao lưu',
      toastBackupRestoreFail: 'Không khôi phục được bản sao lưu: {err}',
      backupInvalidJson: 'File này không phải JSON hợp lệ',
      backupInvalidFormat: 'Đây không phải file sao lưu của Vutaso AI',
      backupFileTooLarge: 'File sao lưu quá lớn để khôi phục trên trình duyệt ({size}).',
      backupConfirmExportLarge: 'Bản sao lưu này nặng {size}. Tải hoặc khôi phục file lớn có thể làm đơ tab. Tiếp tục?',
      ...
      guideStep3Li4: '<kbd>Ctrl</kbd>/<kbd>Cmd</kbd> + <kbd>F</kbd> — tìm trong cuộc chat đang mở',
      guideStep3Li5: '<kbd>/</kbd> — lệnh slash từ thư viện prompt (<kbd>/review</kbd>, <kbd>/summary</kbd>)',
      ...
      guideStep8Body: 'Trên header: tải Markdown, sao chép Markdown, xuất Word (.docx), in / lưu PDF. Phản hồi AI hỗ trợ Markdown, code highlight, công thức toán, sơ đồ Mermaid.',
      guideStep8Li1: '<kbd>Escape</kbd> — đóng tìm trong chat, modal, menu, preview; thoát sửa tin'
    },
    jp: {
      newChat: '新しいチャット',
      history: '履歴',
      ...
      settingsUsageDash: '日別コスト',
      settingsUsageDashHint: '全チャットの推定費用です。リセットで新しい集計期間を開始します。チャットごとのトークン合計は残ります。',
      settingsUsageDash7d: '7日',
      settingsUsageDash30d: '30日',
      settingsUsageDashPeriod: '期間',
      settingsUsageDashReset: '期間リセット',
      settingsUsageDashResetConfirm: 'コストダッシュボードを消して新しい期間を始めますか？チャットごとのトークン合計は残ります。',
      settingsUsageDashResetDone: '新しい集計期間を開始しました',
      settingsUsageDashEmpty: 'この期間の利用データはまだありません。',
      settingsUsageDashModels: 'モデル別',
      settingsUsageDashMore: '+{n} 件',
      settingsUsageDashResetAt: '期間開始 {date}',
      settingsUsageDashInOut: '入力 {input} · 出力 {output}',
      ...
      settingsBackupHint: '会話、プロンプト、設定をJSONファイルに書き出します。ブラウザを変えたときやデータを消したあとに復元できます。',
      backupIncludeKeys: 'APIキーも含める（このファイルは非公開で保管）',
      backupExportBtn: 'JSONを書き出す',
      backupRestoreBtn: '復元…',
      backupRestoreTitle: 'バックアップを復元',
      backupRestoreSubtitle: 'このファイルの適用方法を選んでください',
      backupRestoreSummary: '会話 {conversations} · メッセージ {messages} · プロンプト {snippets}',
      backupRestoreDate: '書き出し日時 {date}',
      backupRestoreDateUnknown: '書き出し日時は不明です',
      backupRestoreHelp: '置換するとこの端末の会話とプロンプトが上書きされます。結合すると既存データを残してファイル分を追加します。APIキーはこの端末のものを維持します（選択した場合のみ復元）。',
      backupRestoreKeys: 'このファイルのAPIキーも復元する',
      backupRestoreMerge: '結合',
      backupRestoreReplace: '置換',
      backupConfirmReplace: 'この端末の会話とプロンプトをバックアップで置き換えますか？元に戻せません。',
      ...
      guideGotIt: '了解',
      reply: 'Reply',
      exportPdfTitle: '印刷ダイアログを開いています...',
      exportHtmlTitle: 'HTMLをエクスポート中...',
      exportPdfHint: 'ヘッダーとフッターをオフにしてから「PDFに保存」',
      ...
      chatFind: 'チャット内を検索',
      chatFindPlaceholder: 'この会話内を検索',
      chatFindPrev: '前の一致',
      chatFindNext: '次の一致',
      chatFindClose: '検索を閉じる',
      chatFindCount: '{current}/{total}',
      chatFindCountCapped: '{current}/{total}+',
      chatFindNone: 'なし',
      noConversations: '会話がありません',
      conversationGenerating: '生成中…',
      ...
      downloadTableCsv: 'CSVをダウンロード',
      scrollMsgTop: '先頭へスクロール',
      scrollMsgBottom: '末尾へスクロール',
      retry: '再生成',
      continueGeneration: '続ける',
      continueGenerationTitle: '途中で切れた回答の続きを生成',
      branch: '新しい分岐',
      ...
      snippetsSubtitle: 'よく使うプロンプトを保存。入力欄に /review や /summary と入力して挿入できます。',
      ...
      slashCommandEmpty: '一致するプロンプトがありません',
      slashCommandHint: '↑↓ で選択 · Enter で挿入 · Esc で閉じる',
      ...
      compressAborted: '圧縮をキャンセルしました。元のメッセージは保持されています。',
      compressApplyFailed: '会話が変わったため要約を適用できませんでした',
      ...
      compareStatusTruncated: '途中切れ — 選択後に続ける',
      ...
      searchingWeb: 'Web検索中...',
      fetchingWeb: 'ページを取得中...',
      runningShell: 'サンドボックスでコマンド実行中...',
      shellPending: 'Shellサンドボックス使用中…',
      ...
      toastExportPdfOk: '印刷ダイアログを開きました — 必要ならPDFに保存',
      toastExportPdfFail: '印刷ダイアログを開けませんでした: {err}',
      toastModel: 'モデル: {label}',
      toastProvider: 'プロバイダー: {label}',
      toastWebSearchOn: 'Web検索をオンにしました',
      toastWebSearchOff: 'Web検索をオフにしました',
      toastShellOn: 'Shellサンドボックスをオンにしました',
      toastShellOff: 'Shellサンドボックスをオフにしました',
      ...
      toastDownloadCsv: 'CSVをダウンロードしました',
      ...
      toastBackupExportOk: 'バックアップをダウンロードしました',
      toastBackupExportFail: 'バックアップを書き出せませんでした: {err}',
      toastBackupRestoreReplace: '会話 {conversations} 件とプロンプト {snippets} 件を復元しました',
      toastBackupRestoreMerge: '会話 {conversations} 件とプロンプト {snippets} 件を追加しました',
      toastBackupRestoreNothing: 'このバックアップに追加できる新しいデータはありません',
      toastBackupRestoreUsage: 'バックアップからコストダッシュボードを更新しました',
      toastBackupRestoreFail: 'バックアップを復元できませんでした: {err}',
      backupInvalidJson: 'このファイルは有効なJSONではありません',
      backupInvalidFormat: 'Vutaso AIのバックアップファイルではありません',
      backupFileTooLarge: 'このバックアップは大きすぎてブラウザで復元できません（{size}）。',
      backupConfirmExportLarge: 'このバックアップは {size} です。大きなファイルのダウンロードや復元でタブが固まることがあります。続行しますか？',
      ...
      guideStep3Li4: '<kbd>Ctrl</kbd>/<kbd>Cmd</kbd> + <kbd>F</kbd> — この会話内を検索',
      guideStep3Li5: '<kbd>/</kbd> — プロンプトライブラリのスラッシュコマンド（<kbd>/review</kbd>、<kbd>/summary</kbd>）',
      ...
      guideStep8Body: 'ヘッダー: Markdownダウンロード、Markdownコピー、Word (.docx) エクスポート、印刷 / PDF保存。AI応答はMarkdown、コードハイライト、数式、Mermaid図に対応。',
      guideStep8Li1: '<kbd>Escape</kbd> — 検索、モーダル、メニュー、プレビューを閉じる；編集を終了'
    },
    zh: {
      newChat: '新对话',
      history: '历史',
      ...
      settingsUsageDash: '按日费用',
      settingsUsageDashHint: '所有对话的估算费用。重置会开始新周期；各对话的 Token 合计会保留。',
      settingsUsageDash7d: '7天',
      settingsUsageDash30d: '30天',
      settingsUsageDashPeriod: '本周期',
      settingsUsageDashReset: '重置周期',
      settingsUsageDashResetConfirm: '清空费用看板并开始新周期？各对话的 Token 合计会保留。',
      settingsUsageDashResetDone: '已开始新的费用周期',
      settingsUsageDashEmpty: '该范围内暂无用量。',
      settingsUsageDashModels: '按模型',
      settingsUsageDashMore: '+{n} 个模型',
      settingsUsageDashResetAt: '周期开始于 {date}',
      settingsUsageDashInOut: '输入 {input} · 输出 {output}',
      ...
      settingsBackupHint: '将会话、提示词和偏好导出为 JSON 文件。更换浏览器或清除存储后可恢复。',
      backupIncludeKeys: '包含 API Key（请妥善保管此文件）',
      backupExportBtn: '导出 JSON',
      backupRestoreBtn: '恢复…',
      backupRestoreTitle: '恢复备份',
      backupRestoreSubtitle: '选择如何应用此文件',
      backupRestoreSummary: '{conversations} 个对话 · {messages} 条消息 · {snippets} 条提示词',
      backupRestoreDate: '导出时间 {date}',
      backupRestoreDateUnknown: '导出时间未知',
      backupRestoreHelp: '替换会覆盖本机的对话和提示词。合并会保留现有数据并追加文件内容。除非你选择恢复，否则本机 API Key 会保留。',
      backupRestoreKeys: '同时从此文件恢复 API Key',
      backupRestoreMerge: '合并',
      backupRestoreReplace: '替换',
      backupConfirmReplace: '用此备份替换本机的全部对话和提示词？此操作无法撤销。',
      renameTitle: '重命名对话',
      ...
      guideGotIt: '知道了',
      reply: 'Reply',
      exportPdfTitle: '正在打开打印对话框...',
      exportHtmlTitle: '正在导出 HTML...',
      exportPdfHint: '关闭页眉和页脚后，再选择“存储为 PDF”',
      ...
      continueGenerationTitle: '从被截断处继续生成',
      branch: '新建分支',
      ...
      snippets: '提示词库',
      snippetsTitle: '提示词库',
      snippetsSubtitle: '保存并复用常用提示词。在输入框输入 /review、/summary 即可插入。',
      ...
      slashCommands: '斜杠命令',
      slashCommandEmpty: '没有匹配的提示词',
      slashCommandHint: '↑↓ 选择 · Enter 插入 · Esc 关闭',
      ...
      compressAborted: '已取消压缩。原始消息已保留。',
      compressApplyFailed: '对话已变化，无法应用摘要',
      ...
      compareStatusTruncated: '被截断 — 选中后点继续',
      ...
      translateTo: '翻译为',
      searchingWeb: '正在搜索网络...',
      fetchingWeb: '正在获取页面内容...',
      runningShell: '正在沙箱中运行命令...',
      shellPending: 'Shell 沙箱已启用…',
      ...
      toastExportPdfOk: '已打开打印对话框 — 可另存为 PDF',
      toastExportPdfFail: '无法打开打印对话框：{err}',
      toastModel: '模型：{label}',
      toastProvider: '提供商：{label}',
      toastWebSearchOn: '已开启网络搜索',
      toastWebSearchOff: '已关闭网络搜索',
      toastShellOn: '已开启 Shell 沙箱',
      toastShellOff: '已关闭 Shell 沙箱',
      ...
      toastBackupExportOk: '备份已下载',
      toastBackupExportFail: '无法导出备份：{err}',
      toastBackupRestoreReplace: '已恢复 {conversations} 个对话和 {snippets} 条提示词',
      toastBackupRestoreMerge: '已添加 {conversations} 个对话和 {snippets} 条提示词',
      toastBackupRestoreNothing: '此备份没有可添加的新数据',
      toastBackupRestoreUsage: '已从备份更新费用看板',
      toastBackupRestoreFail: '无法恢复备份：{err}',
      backupInvalidJson: '此文件不是有效的 JSON',
      backupInvalidFormat: '这不是 Vutaso AI 备份文件',
      backupFileTooLarge: '此备份过大，无法在浏览器中恢复（{size}）。',
      backupConfirmExportLarge: '此备份大小为 {size}。下载或恢复过大文件可能导致标签页卡住。要继续吗？',
      ...
      guideStep3Li4: '<kbd>Ctrl</kbd>/<kbd>Cmd</kbd> + <kbd>F</kbd> — 在当前对话中查找',
      guideStep3Li5: '<kbd>/</kbd> — 从提示词库使用斜杠命令（<kbd>/review</kbd>、<kbd>/summary</kbd>）',
      ...
      guideStep8Body: '顶栏：下载 Markdown、复制 Markdown、导出 Word (.docx)、打印 / 保存为 PDF。AI 回复支持 Markdown、代码高亮、数学公式、Mermaid 图表。',
      guideStep8Li1: '<kbd>Escape</kbd> — 关闭查找、弹窗、菜单、预览；退出编辑模式'
    }
  };
  ...
  const DOM_BINDINGS = [
    ...
    { sel: '#chatFindBtn', attr: 'aria-label', key: 'chatFind' },
    { sel: '#chatFindBar', attr: 'aria-label', key: 'chatFind' },
    { sel: '#chatFindInput', attr: 'placeholder', key: 'chatFindPlaceholder' },
    { sel: '#chatFindInput', attr: 'aria-label', key: 'chatFindPlaceholder' },
    { sel: '#chatFindPrev', attr: 'title', key: 'chatFindPrev' },
    { sel: '#chatFindPrev', attr: 'aria-label', key: 'chatFindPrev' },
    { sel: '#chatFindNext', attr: 'title', key: 'chatFindNext' },
    { sel: '#chatFindNext', attr: 'aria-label', key: 'chatFindNext' },
    { sel: '#chatFindClose', attr: 'title', key: 'chatFindClose' },
    { sel: '#chatFindClose', attr: 'aria-label', key: 'chatFindClose' },
    ...
    { sel: '#settingsUsageDashLabel', key: 'settingsUsageDash' },
    { sel: '#settingsUsageDashHint', key: 'settingsUsageDashHint' },
    { sel: '#usageDashRange7d', key: 'settingsUsageDash7d' },
    { sel: '#usageDashRange30d', key: 'settingsUsageDash30d' },
    { sel: '#usageDashRangePeriod', key: 'settingsUsageDashPeriod' },
    { sel: '#usageDashResetBtn', key: 'settingsUsageDashReset' },
    { sel: '#usageDashEmpty', key: 'settingsUsageDashEmpty' },
    { sel: '#settingsUsageDashModelsLabel', key: 'settingsUsageDashModels' },
    { sel: '#usageDashRanges', attr: 'aria-label', key: 'settingsUsageDash' },
    { sel: '#settingsBackupLabel', key: 'settingsBackup' },
    { sel: '#settingsBackupHint', key: 'settingsBackupHint' },
    { sel: '#backupIncludeKeysLabel', key: 'backupIncludeKeys' },
    { sel: '#backupExportBtnLabel', key: 'backupExportBtn' },
    { sel: '#backupRestoreBtnLabel', key: 'backupRestoreBtn' },
    { sel: '#backupRestoreTitle', key: 'backupRestoreTitle' },
    { sel: '#backupRestoreSubtitle', key: 'backupRestoreSubtitle' },
    { sel: '#backupRestoreHelp', key: 'backupRestoreHelp' },
    { sel: '#backupRestoreKeysLabel', key: 'backupRestoreKeys' },
    { sel: '#backupRestoreMergeBtn', key: 'backupRestoreMerge' },
    { sel: '#backupRestoreReplaceBtn', key: 'backupRestoreReplace' },
    ...
    { sel: '#slashCommandMenu', attr: 'aria-label', key: 'slashCommands' },
    { sel: '#slashCommandHint', key: 'slashCommandHint' },
    ...
    { sel: '#pdfExportCancelBtn', key: 'cancel' },
