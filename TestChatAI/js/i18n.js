window.I18n = (() => {
  ...
  const HTML_LANG = { en: 'en', vi: 'vi', jp: 'ja' };
  ...
  const STRINGS = {
    en: {
      ...
      composerHint: 'Drag & drop images/documents. Enter to send, Shift + Enter for new line.',
      send: 'Send',
      stop: 'Stop',
      close: 'Close',
      save: 'Save',
      ...
      apiKeyHintOpenAI: 'Stored locally, sent only to OpenAI.',
    ...
    vi: {
      ...
      composerHint: 'Kéo thả ảnh/tài liệu. Enter để gửi, Shift + Enter xuống dòng.',
      send: 'Gửi',
      stop: 'Dừng',
      close: 'Đóng',
      save: 'Lưu',
      ...
      apiKeyDeepSeek: 'API Key (DeepSeek)',
      apiKeyGemini: 'API Key (Gemini)',
      apiKeyHintOpenAI: 'Lưu cục bộ, chỉ gửi tới OpenAI.',
    ...
    jp: {
      ...
      composerHint: '画像/ファイルをドラッグ＆ドロップ。Enterで送信、Shift+Enterで改行。',
      send: '送信',
      stop: '停止',
      close: '閉じる',
      save: '保存',
      ...
      apiKeyDeepSeek: 'API Key (DeepSeek)',
      apiKeyGemini: 'API Key (Gemini)',
      apiKeyHintOpenAI: 'ローカル保存、OpenAIへのみ送信。',
  ...
  const DOM_BINDINGS = [
    ...
    { sel: '.composer-hint', key: 'composerHint' },
    ...
    { sel: 'button[form="settingsForm"]', key: 'save' },
    ...
    { sel: 'label[for="apiKeyInput"]', key: 'apiKeyOpenAI' },
    { sel: 'label[for="anthropicApiKeyInput"]', key: 'apiKeyAnthropic' },
    { sel: 'label[for="deepseekApiKeyInput"]', key: 'apiKeyDeepSeek' },
    { sel: 'label[for="geminiApiKeyInput"]', key: 'apiKeyGemini' },
