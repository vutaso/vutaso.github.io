...
const I18n = (() => {
  ...
  const messages = {
    en: {
      ...
      'batch.previewCapped': 'Showing {shown} of {total} in preview. ZIP still includes all rows.',
      'batch.parsed': '✓ {count} QR codes ready.',
      'batch.parsedSkipped': '✓ {count} QR ready — {skipped} rows skipped (lines: {lines}).',
      'history.saveFailed': 'Could not save history (storage full).',
      ...
      'validation.invalid_whatsapp': 'Enter a WhatsApp phone number (digits) or a full https:// URL.',
      'validation.payload_too_long': 'Content is too long for a scannable QR code. Shorten the text.',
      'validation.preview_render_failed': 'This logo format is not supported on your browser. Try PNG or JPEG.',
      'toast.download': 'Downloaded!',
      ...
      'footer.type.urlWebsite': 'URL & Website',
      'footer.type.wifi': 'WiFi Network',
      'footer.type.vcard': 'vCard Contact',
      'footer.type.emailSms': 'Email & SMS',
      'footer.type.locationSocial': 'Location & Social Media',
      'footer.type.cryptoAppstore': 'Crypto & App Store',
      'footer.feature.colors': 'Custom colors & gradients',
      'footer.feature.logo': 'Logo embedding',
      'footer.feature.export': 'PNG, SVG (raster), JPEG, PDF export',
      'footer.feature.batch': 'Batch generation',
      'footer.feature.darkMode': 'Dark mode',
      'footer.privacy': 'Privacy Policy',
      'footer.terms': 'Terms of Service',
      'footer.copyright': '© 2026 VUTASO. All rights reserved.',
      'footer.qrTrademark': '“QR Code” is a trademark of DENSO WAVE INCORPORATED',
      ...
      'field.showUtm': 'Add UTM campaign parameters',
      'field.utm_source': 'UTM Source',
      'field.utm_medium': 'UTM Medium',
      'field.utm_campaign': 'UTM Campaign',
      'field.utm_term': 'UTM Term (optional)',
      'field.utm_content': 'UTM Content (optional)',
      ...
      'field.username': 'Username or URL',
      'field.appName': 'App Name',
      'field.iosUrl': 'iOS App Store URL',
      'field.androidUrl': 'Google Play URL',
      'field.currency': 'Currency',
      'field.crypto.address': 'Wallet Address',
      'field.amount': 'Amount (optional)',
      'field.label': 'Label (optional)',
      'opt.wifi.nopass': 'None (Open)',
      'opt.location.coords': 'Coordinates (Lat/Lng)',
      'opt.location.address': 'Address',
      'opt.crypto.custom': 'Custom',
      'ui.quickCombos': 'Quick Style Combos',
      'ui.dotStyle': 'Dot Style',
      'ui.cornerSquare': 'Corner Square',
      'ui.cornerDot': 'Corner Dot',
      'ui.colorMode': 'Color Mode',
      'ui.solid': 'Solid',
      'ui.linear': 'Linear',
      'ui.radial': 'Radial',
      'ui.foreground': 'Foreground',
      'ui.foreground2': 'Foreground 2',
      'ui.background': 'Background',
      'ui.transparentBg': 'Transparent background',
      'ui.bgMode': 'Background Mode',
      'ui.background2': 'Background 2',
      'ui.bgGradientAngle': 'BG Gradient Angle',
      'ui.unifiedColors': 'Same color for dots & corners',
      'ui.cornerSquareColor': 'Corner Square Color',
      'ui.cornerDotColor': 'Corner Dot Color',
      'ui.dotGradientAngle': 'Dot Gradient Angle',
      'ui.qrSize': 'QR Size',
      'ui.margin': 'Margin',
      'ui.errorCorrection': 'Error Correction',
      'ui.saveStyle': 'Save Style JSON',
      'ui.loadStyle': 'Load Style',
      'ui.resetStyle': 'Reset',
      ...
      'tips.logo_large': 'A large logo can make the QR harder to scan. Keep it under 32%.',
      ...
      'accordion.logo': 'Logo',
      'ui.logoHint': 'Add an image to the center of the QR code. PNG, JPEG, WebP or SVG. Error correction is raised to H so the code still scans.',
      'ui.logoChoose': 'Choose image',
      'ui.logoRemove': 'Remove',
      'ui.logoSize': 'Logo size',
      'ui.logoHideDots': 'Hide dots behind logo',
      'ui.logoPreviewAlt': 'Logo in QR code',
      'ui.logoAdded': 'Logo added to QR code.',
      'ui.logoRemoved': 'Logo removed.',
      'ui.logoError.too_large': 'Image is too large. Use a file under 2 MB.',
      'ui.logoError.invalid_type': 'Use PNG, JPEG, WebP, GIF or SVG.',
      'ui.logoError.decode_failed': 'Could not read this image. Try PNG or JPEG.',
    ...
    vi: {
      ...
      'batch.previewCapped': 'Xem trước {shown}/{total}. File ZIP vẫn gồm tất cả dòng.',
      'batch.parsed': '✓ {count} mã QR sẵn sàng.',
      'batch.parsedSkipped': '✓ {count} mã sẵn sàng — {skipped} dòng bỏ qua (dòng: {lines}).',
      'history.saveFailed': 'Không lưu được lịch sử (bộ nhớ đầy).',
      ...
      'validation.invalid_whatsapp': 'Nhập số điện thoại WhatsApp (chữ số) hoặc URL https:// đầy đủ.',
      'validation.payload_too_long': 'Nội dung quá dài để quét QR ổn định. Hãy rút ngắn.',
      'validation.preview_render_failed': 'Trình duyệt hiện không hỗ trợ ảnh logo này. Hãy thử PNG hoặc JPEG.',
      'toast.download': 'Đã tải xuống',
      ...
      'footer.type.urlWebsite': 'URL & trang web',
      'footer.type.wifi': 'Mạng WiFi',
      'footer.type.vcard': 'Danh thiếp vCard',
      'footer.type.emailSms': 'Email & SMS',
      'footer.type.locationSocial': 'Vị trí & mạng xã hội',
      'footer.type.cryptoAppstore': 'Crypto & App Store',
      'footer.feature.colors': 'Màu & gradient tùy chỉnh',
      'footer.feature.logo': 'Nhúng logo',
      'footer.feature.export': 'Xuất PNG, SVG (ảnh nhúng), JPEG, PDF',
      'footer.feature.batch': 'Tạo hàng loạt',
      'footer.feature.darkMode': 'Chế độ tối',
      'footer.privacy': 'Chính sách bảo mật',
      'footer.terms': 'Điều khoản dịch vụ',
      'footer.copyright': '© 2026 VUTASO. Mọi quyền được bảo lưu.',
      'footer.qrTrademark': '‘Mã QR’ là nhãn hiệu của DENSO WAVE INCORPORATED',
      'contentSuffix': '',
      'type.url': 'URL',
      'type.text': 'Văn bản',
      'type.wifi': 'WiFi',
      ...
      'type.appstore': 'App Store',
      'type.crypto': 'Crypto',
      'field.url': 'URL website',
      'field.showUtm': 'Thêm tham số chiến dịch UTM',
      'field.utm_source': 'UTM Source',
      'field.utm_medium': 'UTM Medium',
      'field.utm_campaign': 'UTM Campaign',
      'field.utm_term': 'UTM Term (tuỳ chọn)',
      'field.utm_content': 'UTM Content (tuỳ chọn)',
      'field.text': 'Văn bản',
      'field.ssid': 'Tên mạng (SSID)',
      'field.password': 'Mật khẩu',
      'field.security': 'Bảo mật',
      'field.hidden': 'Mạng ẩn',
      'field.firstName': 'Tên',
      'field.lastName': 'Họ',
      ...
      'field.mode': 'Cách nhập',
      'field.lat': 'Vĩ độ',
      'field.lng': 'Kinh độ',
      'field.platform': 'Nền tảng',
      'field.username': 'Tên người dùng hoặc URL',
      'field.appName': 'Tên ứng dụng',
      'field.iosUrl': 'URL App Store (iOS)',
      'field.androidUrl': 'URL Google Play',
      'field.currency': 'Tiền tệ',
      'field.crypto.address': 'Địa chỉ ví',
      'field.amount': 'Số lượng (tuỳ chọn)',
      'field.label': 'Nhãn (tuỳ chọn)',
      'opt.wifi.nopass': 'Không (mạng mở)',
      'opt.location.coords': 'Tọa độ (vĩ độ/kinh độ)',
      'opt.location.address': 'Địa chỉ',
      'opt.crypto.custom': 'Tuỳ chỉnh',
      'ui.quickCombos': 'Tổ hợp kiểu nhanh',
      'ui.dotStyle': 'Kiểu chấm',
      'ui.cornerSquare': 'Ô góc',
      'ui.cornerDot': 'Chấm góc',
      'ui.colorMode': 'Chế độ màu',
      'ui.solid': 'Đơn sắc',
      'ui.linear': 'Tuyến tính',
      'ui.radial': 'Tỏa tròn',
      'ui.foreground': 'Màu trước',
      'ui.foreground2': 'Màu trước 2',
      'ui.background': 'Nền',
      'ui.transparentBg': 'Nền trong suốt',
      'ui.bgMode': 'Chế độ nền',
      'ui.background2': 'Nền 2',
      'ui.bgGradientAngle': 'Góc gradient nền',
      'ui.unifiedColors': 'Cùng màu cho chấm và góc',
      'ui.cornerSquareColor': 'Màu ô góc',
      'ui.cornerDotColor': 'Màu chấm góc',
      'ui.dotGradientAngle': 'Góc gradient chấm',
      'ui.qrSize': 'Kích thước QR',
      'ui.margin': 'Lề',
      'ui.errorCorrection': 'Sửa lỗi',
      'ui.saveStyle': 'Lưu style JSON',
      'ui.loadStyle': 'Tải style',
      'ui.resetStyle': 'Đặt lại',
      ...
      'tips.logo_large': 'Logo lớn có thể làm QR khó quét. Nên giữ dưới 32%.',
      ...
      'accordion.logo': 'Logo',
      'ui.logoHint': 'Thêm hình vào giữa mã QR. PNG, JPEG, WebP hoặc SVG. Mức sửa lỗi được nâng lên H để vẫn quét được.',
      'ui.logoChoose': 'Chọn hình',
      'ui.logoRemove': 'Gỡ',
      'ui.logoSize': 'Kích thước logo',
      'ui.logoHideDots': 'Ẩn chấm phía sau logo',
      'ui.logoPreviewAlt': 'Logo trên mã QR',
      'ui.logoAdded': 'Đã thêm logo vào mã QR.',
      'ui.logoRemoved': 'Đã gỡ logo.',
      'ui.logoError.too_large': 'Ảnh quá lớn. Dùng file dưới 2 MB.',
      'ui.logoError.invalid_type': 'Dùng PNG, JPEG, WebP, GIF hoặc SVG.',
      'ui.logoError.decode_failed': 'Không đọc được ảnh này. Hãy thử PNG hoặc JPEG.',
  ...
  const faq = {
    en: [
      ...
      { q: 'What file formats can I download?', a: 'PNG (1×, 2×, 3×), SVG (raster embedded), JPEG, and PDF. Frame templates are included in PNG, JPEG, and PDF exports.' },
      { q: 'Will my QR codes expire?', a: 'No. Static QR codes never expire. The encoded content stays the same forever.' },
      { q: 'Can I add my logo?', a: 'Yes. Use Logo in Customize to upload PNG, JPEG, WebP or SVG. Error correction is raised to H. You can also pick a social brand template that already includes the official logo.' },
    ...
    vi: [
      ...
      { q: 'Tải được những định dạng nào?', a: 'PNG (1×, 2×, 3×), SVG (ảnh raster nhúng), JPEG và PDF. Khung QR được gộp vào PNG, JPEG và PDF.' },
      { q: 'Mã QR có hết hạn không?', a: 'Không. Mã QR tĩnh không hết hạn — nội dung mã hóa giữ nguyên vĩnh viễn.' },
      { q: 'Có thêm logo được không?', a: 'Có. Trong Tùy chỉnh, mở Logo rồi tải PNG, JPEG, WebP hoặc SVG. Mức sửa lỗi được nâng lên H. Bạn cũng có thể chọn mẫu mạng xã hội đã có logo chính thức.' },
