...
const I18n = (() => {
  ...
  const faq = {
    en: [
      ...
      { q: 'Can I add my logo?', a: 'Yes. Pick a social brand template (Facebook, Instagram, and more) — each includes the official logo with error correction H for reliable scanning.' },
    ...
    vi: [
      ...
      { q: 'Có thêm logo được không?', a: 'Có. Chọn mẫu thương hiệu mạng xã hội (Facebook, Instagram, …) — mỗi mẫu có logo chính thức và mức sửa lỗi H để quét ổn định.' },
